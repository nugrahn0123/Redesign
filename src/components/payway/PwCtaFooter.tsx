    ...
    <section className="relative w-full overflow-hidden flex flex-col ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 items-center w-full gap-6 md:gap-4 border-t border-white/10 mt-12 md:mt-20 lg:mt-24 pt-8 md:pt-10">
            ...
            <div className="flex justify-center md:justify-end gap-3 order-3">
              ...
              <a href="https://web.facebook.com/sakusultanind" target="_blank" rel="noopener noreferrer" aria-label="Facebook Saku Sultan" className="flex items-center justify-center w-9 h-9 rounded-full border border-white/10 bg-white/5 backdrop-blur-xl hover:bg-white/20 transition-colors duration-300" tabIndex={0}>
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#fff" stroke="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                </svg>
              </a>
              {/* Twitter/X */}
              <a href="https://twitter.com/sakusultanind" target="_blank" rel="noopener noreferrer" aria-label="Twitter Saku Sultan" className="flex items-center justify-center w-9 h-9 rounded-full border border-white/10 bg-white/5 backdrop-blur-xl hover:bg-white/20 transition-colors duration-300" tabIndex={0}>
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#fff" stroke="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="https://www.instagram.com/sakusultanind/" target="_blank" rel="noopener noreferrer" aria-label="Instagram Saku Sultan" className="flex items-center justify-center w-9 h-9 rounded-full border border-white/10 bg-white/5 backdrop-blur-xl hover:bg-white/20 transition-colors duration-300" tabIndex={0}>
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="https://www.youtube.com/channel/UCxnNwYx24S0y9Subcv04OIA" target="_blank" rel="noopener noreferrer" aria-label="YouTube Saku Sultan" className="flex items-center justify-center w-9 h-9 rounded-full border border-white/10 bg-white/5 backdrop-blur-xl hover:bg-white/20 transition-colors duration-300" tabIndex={0}>
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#fff" stroke="currentColor" strokeWidth="0">
      ...
      <div className="relative z-10 w-full mt-10 lg:mt-12 overflow-hidden">
        <div className="flex justify-center items-center w-full px-0 h-[150px] sm:h-[250px] lg:h-[350px] overflow-hidden">
          <span
            className="block w-[130vw] sm:w-[140vw] md:w-[150vw] lg:w-[170vw] font-bold text-[80px] sm:text-[180px] md:text-[240px] lg:text-[345px] tracking-[-4px] sm:tracking-[-8px] lg:tracking-[-15px] select-none pointer-events-none whitespace-nowrap leading-[0.8] -ml-[14%] sm:-ml-[12%] md:-ml-[10%] lg:-ml-[8%]"
            style={{
